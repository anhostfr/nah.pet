		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div class="space-y-2">
				...
				<p class="text-xs text-muted-foreground">
					L'email ne peut pas être modifié via OAuth
				</p>
			</div>
			<div class="space-y-2">
				<Label>Statut</Label>
	...
	<Card.Content class="space-y-4">
		<div class="space-y-2">
			...
			<p class="text-sm text-muted-foreground">
				Votre compte utilise l'authentification OAuth. 
				Pour modifier votre mot de passe, rendez-vous sur votre fournisseur d'authentification.
			</p>
		</div>
