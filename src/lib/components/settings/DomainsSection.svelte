	...
	<Card.Header>
		<div class="flex items-center justify-between">
			<div>
				...
				<Card.Description>Configurez vos propres domaines pour créer des liens courts personnalisés</Card.Description>
			</div>
							...
							<div class="p-3 bg-muted rounded-lg">
								...
								{:else}
									<ol class="list-decimal list-inside space-y-1 text-sm">
										...
										<li>Rendez-le accessible via https://{domain.domain}/.well-known/nah-pet-verification.txt</li>
									</ol>
								{/if}
							</div>
