...
export const Query = z.object({
  days: z.coerce.number().min(1).max(365).optional().default(30).describe("Number of days to get stats for")
});
...
export default new Endpoint({ Param, Query, Output, Error, Modifier }).handle(async (input, evt) => {
